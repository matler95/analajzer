...
# FIX #10: Removed _agent_debug_log() and its hardcoded Windows path
# (r"c:\Users\Mateusz\Desktop\...").  That function silently failed on
# non-Windows and was dead code in production.
