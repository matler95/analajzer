...
async function fetchPage(url) {
  ...
  const attempts = [
    // Base mode
    { Accept: "text/plain" },
    // Ask Reader to include iframe and shadow DOM content
    { Accept: "text/plain", "x-with-iframe": "true", "x-with-shadow": "true" },
    // Same as above + prefer broad extraction
    { Accept: "text/plain", "x-with-iframe": "true", "x-with-shadow": "true", "x-target-selector": "main,article,body" },
  ];
